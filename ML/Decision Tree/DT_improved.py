...
class decision_tree:
    def __init__(self, max_depth = 3, min_leaf_size = 2, min_information_gain = 0.1):
    ...
    def _best_split_line(self, X, y, ):
        ...
        for feature in range(n_features):
            ...
            for support_point in vals:
                ...
                if information_gain > best_gain and information_gain > self._min_information_gain:
                    best_gain = information_gain
                    best_line = {'feature' : feature, 'threshold' : support_point}
        # returns the best splitting line available, provided the information gain is more than some prior specified threshold, if not then returns 'None'
        return best_line
